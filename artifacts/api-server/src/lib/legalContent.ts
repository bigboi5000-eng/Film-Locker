...
export function privacyPolicyHtml(): string {
  return page(
    ...
    <ul>
      ...
      <li><strong>Google Gemini</strong> — used to identify films from a shared social link's caption/audio/video, and to turn a natural-language search ("a 90 minute horror film like X") into film suggestions. Content you paste or share for these purposes is sent to Google for processing.</li>
...
export function termsOfServiceHtml(): string {
  return page(
    ...
    <p>
      ...
      rate and comment on them, and recommend films to people you follow.
      Film data is sourced from The Movie Database (TMDB); Film Locker is
      not affiliated with or endorsed by TMDB, IMDb, or any streaming
      service referenced in the app.
    </p>
    ...
    <ul>
      ...
      <li>Post comments that are illegal, hateful, or infringe someone else's rights;</li>
    ...
    <h2>Your content</h2>
    <p>
      You own the comments, ratings, and messages you post. By posting
      them, you allow Film Locker to display them to other users according
      to your account's privacy setting (public or private) as described in
      our Privacy Policy.
    </p>
    ...
    <p>
      ...
      Recommendations and film identification from shared links use Google
      Gemini and may occasionally be wrong — always verify before relying
      on them.
    </p>
